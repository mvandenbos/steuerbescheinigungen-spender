...
export default new Vuex.Store({
  ...
  mutations: {
    ...
    UPDATE_DUPLICATECTSPENDERID_DATA: (state, data) => state.duplicateCTSpenderIDs = data,
    UPDATE_DUPLICATEDONORSPENDERID_DATA: (state, data) => state.duplicateDonorSpenderIDs = data,
    UPDATE_MISMATCHEDSPENDERIDSINADDISON_DATA: (state, data) => state.misMatchedSpenderIDsInAddison = data,
  ...
  actions: {
    ...
    UPDATE_DUPLICATECTSPENDERID_DATA: ({ commit }, data) => commit('UPDATE_DUPLICATECTSPENDERID_DATA', data),
    UPDATE_DUPLICATEDONORSPENDERID_DATA: ({ commit }, data) => commit('UPDATE_DUPLICATEDONORSPENDERID_DATA', data),
    UPDATE_MISMATCHEDSPENDERIDSINADDISON_DATA: ({ commit }, data) => commit('UPDATE_MISMATCHEDSPENDERIDSINADDISON_DATA', data),
